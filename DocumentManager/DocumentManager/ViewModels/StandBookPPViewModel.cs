...
{
    public class StandBookPPViewModel : NotifyPropertyChanged
    {
        ...
        private LoadOperation<Web.Model.standbook> LoadStandBookEntities()
        {
            ...
            lQuery = lQuery.Where(c => (c.groupid == 2));
        ...
        {
            InputStandBookPP lInputStandBookPP = new InputStandBookPP();
            lInputStandBookPP.Closed += new EventHandler(InputStandBook_Closed);
            lInputStandBookPP.Show();
        }
        ...
        private void onOpenDownloadTempFile()
        {
            ...
            TempSaveFileDialog.GetType().GetMethod("set_DefaultFileName").Invoke(TempSaveFileDialog, new object[] { "普票申请表模板.xls" });
