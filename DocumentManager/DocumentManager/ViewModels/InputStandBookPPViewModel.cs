...
{
    public class InputStandBookPPViewModel : NotifyPropertyChanged
    {
        ...
        public InputStandBookPPViewModel(ChildWindow aChildWindow)
        {
            IsBusy = false;
        ...
        private void loadOperationTaxPayer_Completed(object sender, EventArgs e)
        {
            ...
            foreach (Web.Model.taxpayer taxpayer in loadOperation.Entities)
            {
                ...
                if (lTaxPayerEntity.TaxPayerGroupId == 2)
                {
