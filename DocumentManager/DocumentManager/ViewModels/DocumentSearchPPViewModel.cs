...
{
    public class DocumentSearchPPViewModel : NotifyPropertyChanged
    {
        ...
        public DocumentSearchPPViewModel()
        {
        ...
        private LoadOperation<Web.Model.taxpayer> LoadTaxPayerEntities()
        {
            ...
            lQuery = lQuery.Where(c => (c.taxpayer_group_id == 2));
