...
{
    public class DocumentSearchGDViewModel : NotifyPropertyChanged
    {
        ...
        public DocumentSearchGDViewModel()
        {
        ...
        private LoadOperation<Web.Model.taxpayer> LoadTaxPayerEntities()
        {
            ...
            lQuery = lQuery.Where(c => (c.taxpayer_group_id == 0));
